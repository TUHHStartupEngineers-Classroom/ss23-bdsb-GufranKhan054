...
patent_tbl <- vroom(
  file       = "C:/Users/Mohd Gufran/Downloads/business data Basics/ds_data/Patent_data_reduced/patent.tsv",
  delim      = "\t",
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
uspc_tbl <- vroom(
  file       = "C:/Users/Mohd Gufran/Downloads/business data Basics/ds_data/Patent_data_reduced/uspc.tsv",
  delim      = "\t",
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
patent_assignee_tbl <- vroom(
  file       = "C:/Users/Mohd Gufran/Downloads/business data Basics/ds_data/Patent_data_reduced/patent_assignee.tsv",
  delim      = "\t",
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
assignee_tbl <- vroom(
  file       = "C:/Users/Mohd Gufran/Downloads/business data Basics/ds_data/Patent_data_reduced/assignee.tsv",
  delim      = "\t",
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
